...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("activities_json_url", sa.String(2048), nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("display_name", sa.String(255), index=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("mode", sa.String(64), index=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("activity_name", sa.String(512), index=True, nullable=False),
        sa.Column("activity_path_frontend", sa.String(1024), nullable=False),
        sa.Column("color", sa.String(64), nullable=True),
        sa.Column("category", sa.String(255), nullable=True),
        sa.Column("frequency_key", sa.String(128), index=True, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("task_key", sa.String(255), index=True, nullable=False),
        sa.Column("name", sa.String(512), nullable=False),
        sa.Column("description", sa.String(2048), nullable=True),
        sa.Column("url", sa.String(2048), nullable=False),
        sa.Column("confirmation_type", sa.String(64), index=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("assigned_token", sa.String(512), index=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("language", sa.String(32), index=True, nullable=False),
        sa.Column("activities_json_data", sa.JSON(), nullable=False),
        sa.Column("content_hash", sa.String(128), index=True, nullable=True),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column("timeline_key", sa.String(255), index=True, nullable=False),
        sa.Column("display_name", sa.String(255), nullable=False),
        sa.Column("description", sa.String(2048), nullable=True),
        sa.Column("mode", sa.String(64), index=True, nullable=False),
        sa.Column("min_coverage", sa.Integer(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("category_name", sa.String(255), index=True, nullable=False),
        sa.Column("sort_order", sa.Integer(), index=True, nullable=False),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column("short", sa.String(255), nullable=True),
        sa.Column("vshort", sa.String(255), nullable=True),
        sa.Column("examples", sa.String(2048), nullable=True),
        sa.Column("color", sa.String(64), nullable=True),
